...
age <- 0
# Subset the data
dat <- dat.France[which(dat.France >= minDate & dat.France$cl_age90 == age), ]
...
#lines(as.Date(dat$jour), dat$posRate7j, col = "#003D1B")
# Graduations
for(i in 0:100){
  abline(h = i, col = gray(0.9))
}
# Add points 
points(as.Date(dat$jour), dat$posRate * 100, pch = 16, cex = 0.6, col = "#28794B")
  mtext("Données: https://www.data.gouv.fr/fr/datasets/donnees-relatives-aux-resultats-des-tests-virologiques-covid-19/# 
Code: https://github.com/flodebarre/covid_indicateurs/blob/main/tauxCroissance.Rmd", side = 1, line = 3.5, adj = 0, cex = 0.5, family = "mono")
```
