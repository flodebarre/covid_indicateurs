...
## Reproduce figure PE 2021-07-29
...
#    sub.Cases <- sub.Cases[which(sub.Cases$reg >= 10), ]
  ...
  # 7-day averages
  aggs$P_ave7 <- sliding.window(aggs$P, pos = 7)
  aggs$incid_hosp_ave7 <- sliding.window(aggs$incid_hosp, pos = 7)
  aggs$incid_dc_ave7 <- sliding.window(aggs$incid_dc, pos = 7)
  ...
  xx <- seq(as.Date("2021-03-22"), as.Date("2021-08-01"), by = "week")
