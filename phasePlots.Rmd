...
for(i in geo.departements$code_departement[nchar(geo.departements$code_departement) < 3]){
  ...
  text(x = incid7[nend], y = ratioIncid7[nend], col = colReg[reg], cex = 0.45, labels = i, adj = c(0.5, -0.5))
  

}

title(main = "Phase plot of Covid-19 cases by départements, France")
colT <- gray(0.5)
