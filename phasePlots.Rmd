...
"), adj = 0, cex = 0.5, family = "mono", line = 5.5, col = gray(0.4))
  ...
  for(i in geo.departements$code_departement[nchar(geo.departements$code_departement) < 3]){
    ...
    points(x = incid7[nend], y = ratioIncid7[nend], col = adjustcolor(colReg[reg], op), cex = 2, pch = 16)
...
# paste0("pics/phaseDep_", formatC(idate, width=3, flag="0"), ".png")
